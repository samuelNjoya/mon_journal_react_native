...
const AssistanceButton = ({ navigation }: any) => {
...
const FloatingAssistanceButton = ({ navigation }: any) => {
    const { t } = useTranslation();
    const handleAssistancePress = () => {
        if (navigation) {
            navigation.navigate('Assistance');
...
const PlatinumCard = ({ navigation }: any) => {
    const { t } = useTranslation();
    ...
    const handleOptionPress = (option: string) => {
        ...
        switch (option) {
            ...
            case 'chat':
                ...
                Alert.alert(t.assistance.chat, t.assistance.unavailableService);
                break;
            default:
                break;
        }
