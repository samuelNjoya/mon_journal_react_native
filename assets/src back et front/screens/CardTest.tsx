...
const AssistanceButton = ({ navigation }) => {
...
const FloatingAssistanceButton = ({ navigation }) => {
    const handleAssistancePress = () => {
        if (navigation) {
            navigation.navigate('Assistance');
        } else {
    ...
    const handleOptionPress = (option) => {
        ...
        switch (option) {
            ...
            case 'chat':
                ...
                Alert.alert("Chat", "Service de chat bientôt disponible");
                break;
            default:
                break;
        }
            ...
            {expanded && (
                <View style={styles.optionsContainer}>
                    ...
                    >
                        ...
                        <Text style={styles.optionText}>Appeler</Text>
                    </TouchableOpacity>
