...
const PaymentMethodes = ({ route, navigation }: any) => {
    ...
    useEffect(() => {
        ...
        if (subs < selectedCard.min_subscription) {
            setError(t.migrations.minimumSubscription + `${selectedCard.min_subscription}`);
        } else if (subs % selectedCard.min_subscription !== 0) {
            setError(t.migrations.subscriptionPas + `${selectedCard.min_subscription}`);
        } else {
            setError('');
        }
    ...
    const checkPaymentStatus = useCallback(async (
        ...
        if (currentAttempt > maxAttempts) {
            ...
            setIsVisible(false);
            setErrorMessage('Timeout: Trop de tentatives sans confirmation');
            return null;
        }
                    ...
                    <View style={styles.cardInfo}>
                        <View style={styles.cardHeader}>
                            ...
                            <View style={styles.cardDetails}>
                                <Text style={styles.cardName}>{selectedCard?.denomination || t.migrations.benefitAccount}</Text>
                    ...
                    <View style={styles.passwordSection}>
                        ...
                        <View style={styles.passwordContainer}>
                            ...
                            {/* <Text style={styles.passwordHelp}>
                                Pour confirmer votre identité et sécuriser la transaction
                            </Text> */}
                        </View>
                    </View>
