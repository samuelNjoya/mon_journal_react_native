...
<form class="kt-form" id="non_acc_transfert_form">
    @csrf
    <div class="row">
        ...
        <div class="col-xl-8">
            <div class="kt-section kt-section--first">
                <div class="kt-section__body">
                    <div class="form-group">
                        ...
                        <input type="text" name="lastname" class="form-control" value="" placeholder="Veuillez entrer le nom du bénéficiaire" aria-describedby="basic-addon1">
                    </div>
                    <div class="form-group">
                        <label>Prénom du bénéficiaire</label>
                        <input type="text" name="firstname" class="form-control" value="" placeholder="Veuillez entrer le prénom du bénéficiaire" aria-describedby="basic-addon1">
            ...
            <div class="kt-portlet__foot">
                <div class="kt-form__actions">
                    <button id="kt_non_acc_transfert" type="submit" class="btn btn-warning">Suivant</button>
                </div>
            </div>
        </div>
        <div class="col-xl-2"></div>
