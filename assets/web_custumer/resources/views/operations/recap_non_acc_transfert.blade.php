        ...
        <div class="col-xl-8">
            ...
            <div class="kt-portlet__foot">
                <div class="kt-form__actions">
                    <button id="kt_confirm_non_acc_transfert" type="submit" class="btn btn-warning">Valider</button>
                </div>
            </div>
        </div>
        <div class="col-xl-2"></div>
...
<script>
    $('#kt_confirm_non_acc_transfert').click(function (e) {
        e.preventDefault();
        let btn = $(this);
        ...
        form.ajaxSubmit({
            url: "{{route("spx.op.post.nonaccount_transfert")}}",
            data:{"phone_number":'{{$phone_number}}',"amount":'{{$amount}}',"firstname":'{{$firstname}}',"lastname":'{{$lastname}}'},
            method:"POST",
            success: function (response, status, xhr, $form) {
                ...
                if (response.status === 1){
                    ...
                    $('#non_account_transfert_body').html(response.view);
