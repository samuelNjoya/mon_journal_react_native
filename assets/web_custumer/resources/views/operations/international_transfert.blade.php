<form class="kt-form" id="international_transfert_form">
    @csrf
    <div class="row">
        ...
        <div class="col-xl-8">
            <div class="kt-section kt-section--first">
                <div class="kt-section__body">
                        ...
                        <div>
                            <div class="input-group">
                                <div class="input-group-prepend"><span class="input-group-text"><i
                                            class="la la-phone"></i>+237</span></div>
                                <input type="text" name="phone_number" class="form-control" value=""
                                    placeholder="Veuillez entrer le numéro de téléphone du bénéficiaire"
                                    aria-describedby="basic-addon1">
                            </div>
                            <span class="form-text text-muted">votre numéro de téléphone doit tenir sur 9
                                chiffres.</span>
                        </div>
                    </div>-->
                    <!--div class="form-group" id="cash_phone_number" style="display: none;">
                        ...
                        <div>
                            <div class="input-group">
                                ...
                                <input type="text" name="phone_number_" class="form-control" value="" placeholder="Veuillez entrer le numéro de téléphone" aria-describedby="basic-addon1">
                            </div>
                    ...
                    <!--div class="form-group" id="cash_phone_number" style="display: none;">
                        ...
                        <div class="input-group">
                            <input type="tel" class="form-control"
                                placeholder="Veuillez entrer le numéro de téléphone du bénéficiaire"
                                name="phone_number_" id="phone_number" autocomplete="off"
                                aria-describedby="basic-addon1">
                        </div>
                    ...
                    <div class="form-group" id="cash_phone_number" style="display: none;">
                        <label id="label_phone_number"></label>
                        <div class="input-group">
                            <input type="tel" class="form-control"
                    ...
                    <!--div class="form-group" id="momo_phone_number" style="display: none;">
                        <label>Numéro de téléphone MTN Mobile Money du Beneficiaire</label>
                        <div>
                            <div class="input-group">
                                <div class="input-group-prepend"><span class="input-group-text"><i class="la la-phone"></i>+237</span></div>
                                <input type="text" name="momo_phone_number" class="form-control" value="" placeholder="Veuillez entrer le numéro de téléphone MTN Mobile Money" aria-describedby="basic-addon1">
                            </div>
                            <span class="form-text text-muted">votre numéro de téléphone doit tenir sur 9 chiffres.</span>
                        </div>
                    </div-->
            ...
            <div class="kt-portlet__foot">
                <div class="kt-form__actions">
                    <button id="kt_international_transfert" type="submit" class="btn btn-warning"
