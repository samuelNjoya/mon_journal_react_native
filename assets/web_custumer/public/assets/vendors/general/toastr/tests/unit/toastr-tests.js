...
(function () {
    ...
    var selectors = {
        ...
        toastError: 'div#toast-container > div.toast-errors',
    ...
    module('error');
    test('errors - pass message and title', 3, function () {
        //Arrange
        //Act
        ...
        equal($toast.find('div.toast-title').html(), sampleTitle, 'Sets title');
        equal($toast.find('div.toast-message').html(), sampleMsg, 'Sets message');
        ok($toast.hasClass(iconClasses.error), 'Sets errors icon');
        //Teardown
        $toast.remove();
        clearContainerChildren();
    });
    test('errors - pass message, but no title', 3, function () {
        //Arrange
        //Act
    ...
    test('errors - no message nor title', 3, function () {
        //Arrange
        //Act
    ...
    test('errors - escape html', 2, function () {
        //Arrange
        toastr.options.escapeHtml = true;
        //Act
    ...
    test('toastr errors has aria assertive',1,function() {
        // Arrange
        var $toast = toastr.error('');

        // Act
        ok($toast.attr('aria-live')==='assertive', 'errors toast has aria-live of assertive');
